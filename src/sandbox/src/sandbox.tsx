...
export class Sandbox extends React.Component<
  ISandboxProps,
  { isFooterVisible: boolean; errorMessage: string }
> {
    ...
    if (indexOf !== -1) {
      ...
      for (const param of params) {
        ...
        switch (name) {
          ...
          case "kiosk": {
            this.state = {
              isFooterVisible: value === "true" ? false : true,
              errorMessage: "",
            };
            break;
          }
      ...
      <div id="root">
        <span>
          ...
          {this._globalState.reflector ? (
            ...
            <RenderingZone
              globalState={this._globalState}
              assetUrl={this._assetUrl ?? this.props.assetUrl}
